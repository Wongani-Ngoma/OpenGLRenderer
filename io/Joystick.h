...
#define GLFW_JOYSTICK_AXES_LEFT_TRIGGER 5

class Joystick {
public:
    Joystick(int i);
    
    void update(); //GLFW doesent support callbacks for joysticks, so we write this method, it's like our own pollEvents method
